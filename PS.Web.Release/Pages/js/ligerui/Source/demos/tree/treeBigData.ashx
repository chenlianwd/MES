...
public class treeBigData : IHttpHandler {
    ...
    public object CreateChildren(string prev, int number)
    {
        return CreateChildren(prev, number, false);
    }
    public object CreateChildren(string prev, int number, bool includeChildren )
    {
        var arr = new List<object>() { };
