...
(function ($)
{
    ...
    $.fn.ligerToolBar = function (options, parentGrid)
    {
        options.parentGrid = parentGrid;
    ...
    $.ligerui.controls.ToolBar.ligerExtend($.ligerui.core.UIComponent, {
        ...
        addItem: function (item)
        {
            ...
            item.click && ditem.click(function () { if ($(this).hasClass("l-toolbar-item-disable")) return; item.click(item, p.parentGrid); });
			if (item.menu)
            {
