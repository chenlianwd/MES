    ...
    $.ligerDefaults.Grid.editors['select'] =
     $.ligerDefaults.Grid.editors['combobox'] =
     {
         create: function(container, editParm)
         {
             ...
             options.data = column.editor.data;
             options.slide = false;
             options.valueField = column.editor.valueField || column.editor.valueColumnName;
             options.textField = column.editor.textField || column.editor.displayColumnName;
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
        ...
        _applyEditor: function(obj)
        {
            ...
            var rowid = rowdata ? rowdata['__id'] : null;
            var rowindex = rowdata ? rowdata['__index'] : null;
