...
/*CREATE*/
  ...
  ",tmpstr3,"
  PRIMARY KEY (`id`),
	KEY `FK_recipe_boardinfo` (`boardid`),
  CONSTRAINT `FK_recipe_boardinfo` FOREIGN KEY (`boardid`) REFERENCES ",recipe," (`BoardIndex`)
	) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
  ...
  ",tmpstr1," 
  PRIMARY KEY (`id`),
  KEY `FK_recipe_anainfo` (`boardid`),
  CONSTRAINT `FK_recipe_anainfo` FOREIGN KEY (`boardid`) REFERENCES ",recipe," (`BoardIndex`)
	) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
  ...
  ",tmpstr2," 
  PRIMARY KEY (`id`),
  KEY `FK_recipe_oveninfo` (`boardid`),
  CONSTRAINT `FK_recipe_oveninfo` FOREIGN KEY (`boardid`) REFERENCES ",recipe," (`BoardIndex`)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
/*INSERT*/
